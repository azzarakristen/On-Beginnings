...
const init = ()=>{
  ...
  begin.addEventListener("click", function() {
    ...
    if (counter <story_array.length){
      ...
      if (counter === story_array.length - 1){
        begin.style.display = "none";
        to_end.style.display = "none";
        reload.textContent = "the end - click to restart"
